...
public final class Panel_QuanLySanPham extends javax.swing.JPanel {
    ...
    private final String[] str_TenCot = new String[]{"Mã sản phẩm", "Tên sản phẩm", "Thương hiệu", "Số lượng tồn", "Giá nhập", "Giá bán", "Giảm giá", "VAT", "Bảo hành", "Loại hàng", "Cấu hình"};
